...
function TestDisplayCreation:test_display_invalid_warns_and_defaults_true()
  local warnings = {}
  local originalWarn = ErrorHandler.warn
  ErrorHandler.warn = function(module, code, message)
    table.insert(warnings, { module = module, code = code, message = message })
  end
  ...
  luaunit.assertEquals(#warnings, 1, "should produce exactly one warning")
  luaunit.assertEquals(warnings[1].code, "ELEM_010", "warning code should be ELEM_010")
